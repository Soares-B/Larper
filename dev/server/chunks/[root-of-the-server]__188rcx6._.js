...
var __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/larper/utils/Restructure.ts [app-route] (ecmascript)");
;
;
;
;
    ...
    try {
        ...
        if (filters.anime) {
            ...
            if (searchVar) {
                ...
                restructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(anime, "anime");
        ...
        if (filters.manga) {
            ...
            if (searchVar) {
                ...
                restructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(manga, "manga");
        ...
        if (filters.game) {
            ...
            if (searchVar) {
                ...
                restructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(game, "game");
        ...
        if (filters.book) {
            ...
            if (searchVar) {
                ...
                restructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(book, "book");
        ...
        if (filters.serie) {
            ...
            if (searchVar) {
                ...
                restructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(serie, "serie");
        ...
        if (filters.movie) {
            ...
            if (searchVar) {
                ...
                restructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(movie, "movie");
        ...
        if (filters.music) {
            ...
            if (searchVar) {
                ...
                restructure = (0, __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$utils$2f$Restructure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(music, "music");
...
"[project]/larper/utils/Restructure.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Restructure(media, type) {
    if (type === "anime") {
        const data = new Anime(media);
        return __TURBOPACK__imported__module__$5b$project$5d2f$larper$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(data);
    } else if (type === "manga") {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__188rcx6._.js.map